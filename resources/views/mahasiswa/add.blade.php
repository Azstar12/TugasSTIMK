...
<div class="data-siswa">
            ...
            <form action="/admin/insert/mahasiswa" method="post">
                @csrf
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="nim" class="form-label">NIM <span style="color: red"> *</span></label>
                            <input class="form-control @error('nim') is-invalid @enderror" type="number" id="nim" name="nim" required placeholder="Masukan NIM">
                            @error('nim')
